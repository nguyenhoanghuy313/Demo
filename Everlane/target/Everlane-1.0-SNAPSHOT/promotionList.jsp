        ...
        <div class="list_option_container">
          <div class="list_option_container1">
            <div class="input-group ">
              <a href="editPromotion.jsp" class="btn btn-outline-dark" type="button">New Promotion</a>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            ...
            <div class="table-responsive text-nowrap listtable ">
              <table class="table">
                ...
                %>
                <th><%=p.getPromotionID()%></th>
                <th><%=p.getPromotionName()%></th>
                <th><%=p.getPromotionDescription()%></th>
                <th><%=p.getDiscountRate()%>%</th>
                <th><%=p.getStartDate()%></th>
                <th><%=p.getEndDate()%></th>
                <th><%=p.getBackground_color()%></th>
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="PromotionServlet?input=delete&PromotionID=<%=p.getPromotionID()%>"
                         onclick="return confirm('Are you sure want to delete this promotion?')"
