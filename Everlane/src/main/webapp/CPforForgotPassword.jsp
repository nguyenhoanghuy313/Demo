    ...
    <div class="authentication-inner">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- /Logo -->
          <h4 class="mb-2">Please enter your new password</h4>
              ...
              <label class="form-label">New Password</label>
                <div class="input-group input-group-merge">
                    <input
                            ...
                            autofocus
                    />
                    <span onclick="ShowPassword2()" class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                </div>
...
<%--                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"--%>
                ...
                />
                <span onclick="ShowPassword1()" class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
              </div>
            </div>
            <div style="color: red">
              ${error}
