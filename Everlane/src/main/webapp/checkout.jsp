            ...
            <div class="Payment_Option">
                ...
                <form action="Checkout?mod=2" method="post">
                    <div class="Shipping-Title">
                        <input style="margin-right: 10px" type="radio" id="payment_option2" name="payment_option" value="Cash" required>
