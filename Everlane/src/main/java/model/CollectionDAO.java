...
public class CollectionDAO extends myDAO{
    ...
    public void updateCollection(String xcolname, String xcolImg, String xcoldescrip, Date xcreate_date, int xcolId) {
        try {
