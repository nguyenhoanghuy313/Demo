...
public class ProductImg {
    int product_Img_ID;
    String thumbnail, product_Img_1,product_Img_2, product_Img_3;

    public ProductImg() {
    }

    public ProductImg(int product_Img_ID, String thumbnail, String product_Img_1, String product_Img_2, String product_Img_3) {
