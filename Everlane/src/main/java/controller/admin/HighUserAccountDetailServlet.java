...
@WebServlet(name = "HighUserAccountDetailServlet", value = "/HighUserAccountDetailServlet")
public class HighUserAccountDetailServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (mod == null) {
            ...
            req.getRequestDispatcher("highUserAccount.jsp").forward(req, resp);
        } else {
            if (mod.equals("1")) {
                HttpSession session = req.getSession();
