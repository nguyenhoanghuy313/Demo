...
//        User x = new User();
//        if (email.isEmpty() || password.isEmpty() || repass.isEmpty() || username.isEmpty() || firstname.isEmpty() || lastname.isEmpty() || dob.isEmpty() || gender == 0 || phoneString.isEmpty()) {
...
//                u.addUser(username ,password,email,firstname,lastname,dob,gender,phone);
